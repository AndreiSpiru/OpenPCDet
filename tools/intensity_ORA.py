...
def main():
    """
    Main function to perform intensity-based Object Removal Attacks (ORA) on point cloud data.
    """
            ...
            for condition in os.listdir(sensor_path):
                ...
                if os.path.isdir(condition_path):
                    ...
                    for idx, file_bin in enumerate(source_file_list):
                        ...
                        # Get bounding boxes and convert to numpy
                        bbox = torch.unsqueeze(bboxes[idx], 0)
                        bbox = bbox.cpu().numpy()

                        # Apply intensity-based ORA on points within bounding boxes
