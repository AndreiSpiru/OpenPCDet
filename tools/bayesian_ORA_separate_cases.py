...
# Separate case IoU BORA

# Command to run the script
# python3 bayesian_ORA_separate_cases.py --cfg_file cfgs/kitti_models/pointpillar.yaml --budget 200 --ckpt pointpillar_7728.pth --data_path ~/mavs_code/output_data_converted/0-10/HDL-64E
...
if __name__ == '__main__':
    ...
    # 2 parallel processes is what my machine can handle
